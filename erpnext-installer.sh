...
execute_command "nvm list-remote --lts" "failed to showing list of nvm" "All list of NVM"
#execute_command "nvm install v22.14.0" "failed to installing nvm" "Successfully install nvm"
excute_command "nvm install --lts" "failed to installing nvm" "Successfully install nvm"
